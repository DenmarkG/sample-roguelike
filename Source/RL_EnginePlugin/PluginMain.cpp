...
//============================================================================================================
class RL_EnginePluginClass : public IVisPlugin_cl
{
public:
  ...
  {
    return "RL_EnginePlugin";  // must match DLL name
  }
};

//  global plugin instance
RL_EnginePluginClass g_myComponents;
...
//--------------------------------------------------------------------------------------------
VEXPORT IVisPlugin_cl* GetEnginePlugin_RL_EnginePlugin(){  return &g_myComponents; }


#if (defined _DLL) || (defined _WINDLL)

  //  The engine uses this to get and initialize the plugin dynamically
  VEXPORT IVisPlugin_cl* GetEnginePlugin(){return GetEnginePlugin_RL_EnginePlugin();}
...
void RL_EnginePluginClass::OnInitEnginePlugin()
{
  hkvLog::Info("RL_EnginePluginClass:OnInitEnginePlugin()");
...
void RL_EnginePluginClass::OnDeInitEnginePlugin()
{
  hkvLog::Info("RL_EnginePluginClass:OnDeInitEnginePlugin()");
